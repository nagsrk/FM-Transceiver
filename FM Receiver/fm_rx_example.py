...
# Title: Fm Rx Example
# Author: Naga
# Generated: Tue Apr 23 16:07:58 2013
##################################################
...
class fm_rx_example(grc_wxgui.top_block_gui):
	...
	def get_Mult_constant(self):
		return self.Mult_constant

	def set_Mult_constant(self, Mult_constant):
		self.Mult_constant = Mult_constant
		self.gr_multiply_const_vxx_1.set_k((self.Mult_constant, ))
		self.gr_multiply_const_vxx_0.set_k((self.Mult_constant, ))
